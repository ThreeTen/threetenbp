...
public class ExampleUTC {
    ...
    private static void showDiscontinuities() {
        ...
        Instant t = TrueUTC.SCALE.instant(date(1968, 2, 1));
        ...
        convert(t.minus(Duration.millisDuration(100)), TrueUTC.SCALE);
        convert(t.minus(Duration.millisDuration(80)), TrueUTC.SCALE);
        convert(t.minus(Duration.millisDuration(60)), TrueUTC.SCALE);
        convert(t.minus(Duration.millisDuration(40)), TrueUTC.SCALE);
        convert(t.minus(Duration.millisDuration(20)), TrueUTC.SCALE);
        convert(t, TrueUTC.SCALE);
        convert(t.plus(Duration.millisDuration(20)), TrueUTC.SCALE);

        // In the following case the UTC values repeat while TAI advances
        System.out.println();
        t = TAI.SCALE.instant(TrueUTC.SCALE.instant(date(1965, 1, 1)));
        convert(t.minus(Duration.millisDuration(120)), TrueUTC.SCALE);
        convert(t.minus(Duration.millisDuration(100)), TrueUTC.SCALE);
        convert(t.minus(Duration.millisDuration(80)), TrueUTC.SCALE);
        convert(t.minus(Duration.millisDuration(60)), TrueUTC.SCALE);
        convert(t.minus(Duration.millisDuration(40)), TrueUTC.SCALE);
